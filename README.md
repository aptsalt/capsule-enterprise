...
**▶ Live app: [capsule-8090.vercel.app](https://capsule-8090.vercel.app)**  ·  **Case study: [FOR-8090](https://aptsalt.github.io/capsule-enterprise/FOR-8090.html)**  ·  the hosted app runs the full UI + a live chat agent and live A/B on Gemini; only local session-capture needs Ollama.
